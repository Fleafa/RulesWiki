...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      // Import the Tooltipster JS & CSS
      tooltipster: {
        files: [
          {expand: true, src: ['bower_components/tooltipster/js/jquery.tooltipster.js'], dest: 'static/javascript/tooltipster/', flatten: true, filter: 'isFile'},
          {expand: true, src: ['bower_components/tooltipster/css/tooltipster.css'], dest: 'static/css/', flatten: true, filter: 'isFile'}
        ]
      },
